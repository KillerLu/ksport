package com.killer.ksport.file.util;
...
/**
 * @author ：Killer
 * @date ：Created in 19-7-19 上午9:23
...
public class FtpUtil {
     ...
     * @throws IOException
     */
    public boolean uploadToFtp(InputStream buffIn, String fileName, String dir) throws  Exception {
...
//            System.out.println(existDirectory(dir));
...
//    }
    ...
    public boolean mkdirs(String dir) throws Exception {
        ...
        while (dirs.hasMoreElements()) {
            ...
            //进入目录
            boolean flag=ftpClient.changeWorkingDirectory(temp);
            result = true;
        }
        ftpClient.changeWorkingDirectory("/");
        return result;
    ...
    public static String getDateDir(Date dateParam){
        ...
        return currentYear+"/"+currentMouth+"/"+currentDay;
    }
