package com.killer.ksport.common.core.web;
...
/**
 * @author ：Killer
 * @date ：Created in 19-6-28 上午10:02
...
public class ResponseBuilder {
    ...
    public ResponseBuilder remove(String name)
    {
    ...
    {
        return (int) responseMap.getOrDefault("code", 500) == 200;
    }
}
